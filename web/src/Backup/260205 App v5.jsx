              ...
              .map((p) => (
                ...
                >
                  <Popup>
                    <div>
                      <div>
                        <strong>{p.name}</strong> — sewer path
                      </div>
                      <div>Segments: {p.pipePlan.length}</div>
                      <div>
                        Start pipe OBJECTID: {p.contact?.pipeObjectId ?? "—"}
                      </div>
                      {p.pipe?.objectId && (
                        <div>Current pipe OBJECTID: {p.pipe.objectId}</div>
                      )}
                    </div>
                  </Popup>
                </Polyline>
